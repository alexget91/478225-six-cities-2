...
class Offer extends PureComponent {
  ...
  render() {
    const {offer, reviews, neighbourhood} = this.props;
    ...
    return <div className="page">
      ...
      <main className="page__main page__main--property">
        <section className="property">
          ...
          <Map offerPins={getPinsForMap(neighbourhood, activePlace ? activePlace.id : null)}
            mapType={`offer`} city={offer.city}/>
        </section>
        {neighbourhood.length ? <div className="container">
          <section className="near-places places">
            <h2 className="near-places__title">Other places in the neighbourhood</h2>
            <PlacesList offers={neighbourhood} listType={`offer`} onPlaceHover={this._placeHoverHandler}/>
          </section>
        </div> : ``}
      </main>
    </div>;
